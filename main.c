...
void init(void){
    ...
    texturaTela = SOIL_load_OGL_texture(
        "fundo_inicio.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaTelap = SOIL_load_OGL_texture(
        "fundo_iniciop.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaTela3 = SOIL_load_OGL_texture(
        "dead.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaTela4 = SOIL_load_OGL_texture(
        "venceu.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaSolo = SOIL_load_OGL_texture(
        "solo.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaBixo = SOIL_load_OGL_texture(
        "naruto_inicial2.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaBixo2 = SOIL_load_OGL_texture(
        "super_naruto.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaBixoAndano = SOIL_load_OGL_texture(
        "naruto_andano.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    if (texturaBixoAndano== 0) {
        printf("9Erro do SOIL: '%s'\n", SOIL_last_result());
    }

    texturaBixo2Andano = SOIL_load_OGL_texture(
        "naruto_andano2.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaShuriken= SOIL_load_OGL_texture(
        "shuriken1.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    if (texturaShuriken == 0) {
        printf("11Erro do SOIL: '%s'\n", SOIL_last_result());
    }

    texturaShuriken2= SOIL_load_OGL_texture(
        "shuriken2.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    if (texturaShuriken2 == 0) {
        printf("12Erro do SOIL: '%s'\n", SOIL_last_result());
    }

    texturaShuriken11= SOIL_load_OGL_texture(
        "shuriken1.2.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    if (texturaShuriken11 == 0) {
        printf("13Erro do SOIL: '%s'\n", SOIL_last_result());
    }

    texturaShuriken22= SOIL_load_OGL_texture(
        "shuriken2.2.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    if (texturaShuriken22 == 0) {
        printf("14Erro do SOIL: '%s'\n", SOIL_last_result());
    }

    texturaPassaros = SOIL_load_OGL_texture(
        "birds.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    if (texturaPassaros == 0) {
        printf("15Erro do SOIL: '%s'\n", SOIL_last_result());
    }

    texturaBotao1 = SOIL_load_OGL_texture(
        "botao1.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaBotao3 = SOIL_load_OGL_texture(
        "botao2.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaBotao2 = SOIL_load_OGL_texture(
        "botao3.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaBotao4 = SOIL_load_OGL_texture(
        "botao4.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaBotao5 = SOIL_load_OGL_texture(
        "botao5.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaBotao6 = SOIL_load_OGL_texture(
        "botao6.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaBotao7 = SOIL_load_OGL_texture(
        "botao7.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaTela2 = SOIL_load_OGL_texture(
        "fundo_inicio22.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaTelaM1 = SOIL_load_OGL_texture(
        "tela_fundoM0.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaTelaM2 = SOIL_load_OGL_texture(
        "tela_fundoM1.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
    ...
    texturaTelaM3 = SOIL_load_OGL_texture(
        "tela_fundoM2.png",
        SOIL_LOAD_AUTO,
        SOIL_CREATE_NEW_ID,
		SOIL_FLAG_INVERT_Y
